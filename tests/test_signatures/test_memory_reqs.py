...
paths = [
    ...
    pytest.param((50_000, 5), id="timesteps=50_000,features=5"),
    pytest.param((100_000, 5), id="timesteps=100_000,features=5"),
    pytest.param((200_000, 5), id="timesteps=200_000,features=5"),
    pytest.param((300_000, 5), id="timesteps=300_000,features=5"),
    pytest.param((400_000, 5), id="timesteps=400_000,features=5"),
    ...
    pytest.param((50_000, 10), id="timesteps=50_000,features=10"),
    pytest.param((100_000, 10), id="timesteps=100_000,features=10"),
    pytest.param((200_000, 10), id="timesteps=200_000,features=10"),
    pytest.param((300_000, 10), id="timesteps=300_000,features=10"),
    pytest.param((400_000, 10), id="timesteps=400_000,features=10"),
    ...
    pytest.param((50_000, 20), id="timesteps=50_000,features=20"),
    pytest.param((100_000, 20), id="timesteps=100_000,features=20"),
    pytest.param((200_000, 20), id="timesteps=200_000,features=20"),
    pytest.param((300_000, 20), id="timesteps=300_000,features=20"),
    pytest.param((400_000, 20), id="timesteps=400_000,features=20"),
